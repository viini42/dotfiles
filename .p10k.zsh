...
# local -r vertical_bar='\u2502'
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_BACKGROUND=3
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_CRITICAL_LEVEL=70
  ...
  typeset -g POWERLEVEL9K_USER_BACKGROUND=12
  typeset -g POWERLEVEL9K_USER_VISUAL_IDENTIFIER_EXPANSION=''

  ####################[ host: hostanem]##########################################################
  # Local host colors.
  typeset -g POWERLEVEL9K_HOST_LOCAL_FOREGROUND=7
  typeset -g POWERLEVEL9K_HOST_LOCAL_BACKGROUND=33
  typeset -g POWERLEVEL9K_HOST_LOCAL_VISUAL_IDENTIFIER_EXPANSION=''
